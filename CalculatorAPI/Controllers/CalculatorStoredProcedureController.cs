...
namespace CalculatorAPI.Controllers
{
    ...
    /// Uses the Stored Procedure for Data Access
    /// </summary>
    [RoutePrefix("api/v1/Calculator/SP")]
    public class CalculatorStoredProcedureController : ApiController
    {
        ...
        public CalculatorStoredProcedureController([Named("DbStoredProc")] IDiagnostics diagnostics, IDummyDiagnostics dummyDiagnostics)
        {
